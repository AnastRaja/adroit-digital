...
export const metadata = {
  ...defaultMetadata,
  title: "Best SEO Service Provider | Adroits Digital",
  description:
    "Let Our Best SEO Service Take Your Business to the Top. We are experts in SEO optimization, search engine marketing, On-page and OFF page SEO.",
  keywords: [
  ...
  openGraph: {
    ...
    images: [
      {
        url:
          "https://res.cloudinary.com/decbm52pl/image/upload/v1710589435/OG/pkhxtxgrtxo6pld2dnxg.jpg",
        width: 1200,
        height: 630,
        alt: "Best SEO Service Provider OG Image",
      },
    ],
  },
  robots: {
